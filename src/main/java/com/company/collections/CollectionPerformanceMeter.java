...
public class CollectionPerformanceMeter {
    private static final String MEASURE_PERFORMANCE_PATTERN = "Element quantity: %d, Measure performance of <%s> method ...";
    private static final String ATTEMPT_PATTERN = "Attempt %d ...";
